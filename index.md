...
- **Institution**: Universidad de Buenos Aires<br>
- **Advisor**: [Flavia Bonomo](https://staff.dc.uba.ar/fbonomo/)<br>
- **Thesis**: On the thinness of trees and other graph classes ([PDF](https://staff.dc.uba.ar/fbonomo/docs/tesis/tesis_agus_eric.pdf), [Slides in Spanish](/assets/talks/defensa-tesis-licenciatura.pdf)).<br>
...
## Talks
- **¡Péguenles a esos (grafos) menores!** ([Slides in Spanish](/assets/talks/seminario-grafos-2026.pdf)). Seminario de grafos, Facultad de Ciencias Exactas y Naturales, Universidad de Buenos Aires, April 2026. Joint work with Marin Bougeret and Ignasi Sau.
